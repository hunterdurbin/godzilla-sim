...
enum CardTrait {KAIJU, MECHA, ALIEN, MUTANT, ANGUIRUS, BABY_GODZILLA, BARAGON, BATTRA, BIOLLANTE, BOAT, CHIBI_GODZILLA_RAIDS_AGAIN, CITY, CRYSTAL, DAGAHRA, DESGHIDORAH, DESTOROYAH, DORAT, EBIRAH, FEST, FINAL_WARS, FOURTH_FORM, GABARA, GHIDORAH, GHOGO, GIANT_CONDOR, GIGAN, GODZILLA, GODZILLASAURUS, GODZILLA_JR, GOROSAURUS, HEDORAH, JET_JAGUAR, KAMACURAS, KING_CAESAR, KING_GHIDORAH, KUMONGA, LITTLE_GODZILLA, MANDA, MECH, MECHAGODZILLA, MEGAGUIRUS, MEGALON, MEGANULA, MINILLA, MOGUERA, MONSTER_X, MOTHRA, ORGA, RODAN, SACRED_GUARDIAN_BEASTS, SECOND_FORM, SPACEGODZILLA, SUPER_X, THIRD_FORM, TITANOSAURUS, TOKEN, TWENTY_THIRD_CENTURY, VARAN, WEAPON, ZILLA}
