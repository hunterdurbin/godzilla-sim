...
- destroy_target: EBP04-003 (enter rank≤6 ×1, rank1 strategy in play), EBP04-015 (hand discarded + opp rage 0: rank≤6 ×1), EBP04-020 (enter, Base in play: all adjacent), EBP04-034 (enter, 3+ colors discard: rank≤5 ×1), EBP04-035 (enter: lowest zones × color count), EBP04-074 (enter: 1 opp strategy), EBP04-083 (enter: all opp zones 6–8), EBP04-084 (enter: all opp column), ESD01-006 (enter rank≤4 ×1, burst2), ESD01-007 (enter: all opp column, burst3), ESD01-016 (enter: all opp column), ESD02-002 (enter rank≤4 ×1), ESD02-015 (enter: chosen zone + adjacent), EPR-004 (enter: all opp column), EPR-005 (enter: all opp column), EPR-014 (enter: all opp column)
- stat_modifier: EBP04-006 011 016 017 019 023 031 032 036 037 038 044 048 054 056 057 058 060 065 066 068 069 070 071 081 082, ESD01-003 009, ESD02-006 011 012, EFC01-001 004 006, EPR-015 (+5000 CP w/ RIDE card in discard)
...
- bespoke: EBP04-002 004 005 007 009 010 012 013 014 018 022 024 025 026 027 028 029 030 033 039 040 041 042 043 045 046 047 049 050 051 052 053 055 059 062 063 064 067 072 073 077 078 079 080 085 086 087 089 T01, ESD01-010 011 012 014, ESD02-003 004 009 014, EFC01-002 003 005, ESC01-001 002 003 004 005 006, EPR-016 (counter start own: stack Mech/Weapon/RIDE from hand, +5000 CP loaded, end-phase self-destroy — test_epr_bespoke.gd)
