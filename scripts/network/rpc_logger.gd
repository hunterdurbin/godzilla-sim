...
var _send_stats: Dictionary = {}
var _recv_stats: Dictionary = {}


func log_send(rpc_name: String, payload_bytes: int) -> void:
	if not enabled:
		return
	_record(_send_stats, rpc_name, payload_bytes)


func log_receive(rpc_name: String, payload_bytes: int) -> void:
	if not enabled:
		return
...
func _record(stats: Dictionary, rpc_name: String, payload_bytes: int) -> void:
...
func _print_group(stats: Dictionary, direction: String) -> void:
